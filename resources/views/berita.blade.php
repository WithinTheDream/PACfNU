...
<div class="bg-[#EFFFF5] py-16 text-center border-b border-green-100">
    <h1 class="text-3xl md:text-4xl font-extrabold text-[#00923F]">Kabar Fatayat</h1>
    <p class="mt-3 text-gray-600 max-w-2xl mx-auto text-lg">Informasi, kegiatan, dan liputan seputar Fatayat NU Tahunan.</p>
</div>
        ...
        @forelse ($articles as $article)
            <div class="bg-white rounded-xl border border-green-100 overflow-hidden shadow-sm hover:shadow-lg transition duration-300 flex flex-col group">
                ...
                <div class="relative h-64 bg-gray-50 flex items-center justify-center overflow-hidden border-b border-gray-100">
                    ...
                    @endif
                    <div class="absolute top-0 right-0 bg-yellow-500 text-yellow-950 text-xs font-bold px-3 py-1 rounded-bl-lg">
                        Berita
                    </div>
                </div>
                ...
                <div class="p-5 flex-grow flex flex-col">
                    ...
                    <div class="space-y-2 text-sm text-gray-600 mb-5 flex-grow">
                        ...
                        <div class="flex items-center gap-2">
                            <svg class="w-4 h-4 text-[#00923F]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                            Admin Fatayat
                        </div>
                    </div>

                    <a href="{{ url('/berita/' . $article->slug) }}" class="block w-full text-center bg-[#00923F] text-white py-2.5 rounded-md hover:bg-green-800 transition font-medium text-sm mt-auto">
                        Baca Selengkapnya
                    </a>
                </div>
            </div>
